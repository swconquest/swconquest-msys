...
#local color strings
  ...
  ("npc1_home_description", "One of their kind, Jango Fett--he was the template for the original clone troopers.  Back in the clone wars, back when you cold tell who was a droid and who was a clone and that was that when it came to war.  Things are different now, of course.  Nothing stops an Imperial thug or a Rebel terrorist from painting up his ship with the wrong colors and massacring a settlement to whip up anger at the other side."),
  ...
  ("npc5_home_recap", "I was born on Reecee, learned to fight on Tatooine, and spent most of my career on Gamorr."),
...
#Actions vis-a-vis civilians
  ...
  ("comment_you_helped_villagers_unfriendly_spiteful",       "I heard that you gave charity to the citizens on the planet of {s51}. As amusing as it is to see you grubbing for favor among my vassals, I would ask you to mind your own business."),
...
#  ("faction_1", "Kingdom of Vaegirs"),
  ("faction_1", "Galactic Empire"),  
#  ("faction_2", "Kingdom of Swadia"),
  ("faction_2", "Rebel Alliance"),  
#  ("faction_3", "Kingdom of Nords"),
  ("faction_3", "Hutt Cartel"),
...
#SW BSG integration
  ("space_combat_practice", "Please board the spaceship to begin^^CONTROLS:^a = increase speed^z = decrease speed^arrow keys = move up/down/left/right^left ctrl = fire lasers^tab = exit training^^NOTE:  This is a training mission, damage for all ships will be recorded, but they will not actually be destroyed."),
...
#own kingdom start-----------------------------------
#SW - modified all center_1_kingdom and higher names
#towns
  ("center_1_kingdom", "Player Kingdom"),
  ("center_2_kingdom", "Player Kingdom"),
  ("center_3_kingdom", "Player Kingdom"),
  ("center_4_kingdom", "Player Kingdom"),
  ("center_5_kingdom", "Player Kingdom"),
  ("center_6_kingdom", "Player Kingdom"),
  ("center_7_kingdom", "Player Kingdom"),
  ("center_8_kingdom", "Player Kingdom"),
  ("center_9_kingdom", "Player Kingdom"),
  ("center_10_kingdom", "Player Kingdom"),
  ("center_11_kingdom", "Player Kingdom"),
  ("center_12_kingdom", "Player Kingdom"),
  ("center_13_kingdom", "Player Kingdom"),
  ("center_14_kingdom", "Player Kingdom"),
  ("center_15_kingdom", "Player Kingdom"),
  ("center_16_kingdom", "Player Kingdom"),
  ("center_17_kingdom", "Player Kingdom"),
  ("center_18_kingdom", "Player Kingdom"),
#castles  
  ("center_19_kingdom", "Player Kingdom"),
  ("center_20_kingdom", "Player Kingdom"),
  ("center_21_kingdom", "Player Kingdom"),
  ("center_22_kingdom", "Player Kingdom"),
  ("center_23_kingdom", "Player Kingdom"),
  ("center_24_kingdom", "Player Kingdom"),
  ("center_25_kingdom", "Player Kingdom"),
  ("center_26_kingdom", "Player Kingdom"),
  ("center_27_kingdom", "Player Kingdom"),
  ("center_28_kingdom", "Player Kingdom"),
  ("center_29_kingdom", "Player Kingdom"),
  ("center_30_kingdom", "Player Kingdom"),
  ("center_31_kingdom", "Player Kingdom"),
  ("center_32_kingdom", "Player Kingdom"),
  ("center_33_kingdom", "Player Kingdom"),
  ("center_34_kingdom", "Player Kingdom"),
  ("center_35_kingdom", "Player Kingdom"),
  ("center_36_kingdom", "Player Kingdom"),
  ("center_37_kingdom", "Player Kingdom"),
  ("center_38_kingdom", "Player Kingdom"),
  ("center_39_kingdom", "Player Kingdom"),
  ("center_40_kingdom", "Player Kingdom"),
  ("center_41_kingdom", "Player Kingdom"),
  ("center_42_kingdom", "Player Kingdom"),
  ("center_43_kingdom", "Player Kingdom"),
  ("center_44_kingdom", "Player Kingdom"),
  ("center_45_kingdom", "Player Kingdom"),
  ("center_46_kingdom", "Player Kingdom"),
  ("center_47_kingdom", "Player Kingdom"),
  ("center_48_kingdom", "Player Kingdom"),
  ("center_49_kingdom", "Player Kingdom"),
  ("center_50_kingdom", "Player Kingdom"),  
  ("center_51_kingdom", "Player Kingdom"),    
  ("center_52_kingdom", "Player Kingdom"),    
  ("center_53_kingdom", "Player Kingdom"),    
  ("center_54_kingdom", "Player Kingdom"),    
  ("center_55_kingdom", "Player Kingdom"),    
  ("center_56_kingdom", "Player Kingdom"),    
  ("center_57_kingdom", "Player Kingdom"),    
  ("center_58_kingdom", "Player Kingdom"),
#own kingdom end-----------------------------------	

#SW - spaceship strings start
  #empire
  ("spaceship_imperial_star_destroyer_name", "Imperial Star Destroyer"),
  #("spaceship_imperial_star_destroyer_desc", "If you're after loads of space for your troops, ^the Imperial Star Destroyer is the way to go. ^^It comes standard with two troop compartments but these ^can be extended to a whopping six.^^Prisoners are also no problem, with between two and four bays available. ^^The ISD has a basic medical facility which can be improved to a MK-II model. ^^The scanners and drive are both MK-I models and can be upgraded to MK-III. ^^Finally, the ship can support a combat computer up to MK-IV, ^with a MK-II unit installed standard."),
  ...
  ("spaceship_imperial_star_destroyer_interdictor_desc", "If you're after loads of space for your troops, ^the Imperial Interdictor Star Destroyer is the way to go."),
  ("spaceship_imperial_dreadnaught_frigate_name", "Imperial Dreadnaught Heavy Cruiser"),
  ("spaceship_imperial_dreadnaught_frigate_desc", " "),
  ("spaceship_imperial_victory_c2_frigate_name", "Imperial Victory-II Frigate"),
  ("spaceship_imperial_victory_c2_frigate_desc", " "),
  ("spaceship_imperial_trade_frigate_name", "Imperial Trade Frigate"),
  ("spaceship_imperial_trade_frigate_desc", " "),
  ("spaceship_tie_fighter_name", "Imperial Tie Fighter"),
  ("spaceship_tie_fighter_desc", " "),
  ("spaceship_imperial_shuttle_name", "Imperial Shuttle"),
  ...
  ("spaceship_imperial_shuttle_desc", "A true beauty, the Imperial Shuttle combines speed with troop support capabilites."),
  #rebel
  ("spaceship_a_wing_name", "A-Wing"),
  ("spaceship_a_wing_desc", "The A-Wing is the fastest fighter in the galaxy."),
  ("spaceship_rebel_transport_name", "Rebel Alliance Cruiser"),
  ...
  ("spaceship_rebel_transport_desc", "The Rebel Alliance Cruiser is a sleek and highly sophisticated battleship."),
  ("spaceship_moncal_cruiser_name", "Mon Cal Cruiser"),
  ("spaceship_moncal_cruiser_desc", " "),  
  ("spaceship_corellian_gunship_name", "Corellian Gunship"),
  ("spaceship_corellian_gunship_desc", " "),  
  ("spaceship_y_wing_name", "Y-Wing"),
  ("spaceship_Y_wing_desc", " "),  
  #hutt
  ("spaceship_hutt_cruiser_name", "Hutt Cruiser"),
  ("spaceship_hutt_cruiser_desc", " "),
  ("spaceship_hutt_frigate_mk1_name", "Hutt MK-1 Frigate"),
  ("spaceship_hutt_frigate_mk1_desc", " "),
  ("spaceship_hutt_frigate_mk2_name", "Hutt MK-2 Frigate"),
  ("spaceship_hutt_frigate_mk2_desc", " "),
  ("spaceship_hutt_trade_name", "Hutt Trade Ship"),
  ("spaceship_hutt_trade_desc", " "),
  ("spaceship_hutt_patrol_name", "Hutt Patrol Ship"),
  ("spaceship_hutt_patrol_desc", " "),
  #other
  ...
  ("spaceship_z95_desc", "The z-95 Headhunter is a fast and agile craft which will see you safely to ^all corners of the galaxy."),
  ("spaceship_scyk_fighter_name", "M3-A Scyk Fighter"),
  ("spaceship_scyk_fighter_desc", " "),
  ("spaceship_mercenary_raider_name", "Mercenary Raider"),
  ...
  ("spaceship_mercenary_raider_desc", " "),  
  ...
  ("spaceship_freighter_desc", "This model Freighter is the workhorse of traders around the galaxy."),
  ("spaceship_mercenary_fighter_name", "Mercenary Fighter"),
  ("spaceship_mercenary_fighter_desc", " "),
  ("spaceship_mercenary_shuttle_name", "Mercenary Shuttle"),
  ("spaceship_mercenary_shuttle_desc", " "),
  ("spaceship_civilian_transport_name", "Civilian Transport"),
  ("spaceship_civilian_transport_desc", " "),
  ("spaceship_civilian_cruiser_name", "Civilian Cruiser"),
  ("spaceship_civilian_cruiser_desc", " "),  
  ("spaceship_bulk_freighter_name", "Bulk Freighter"),
  ("spaceship_bulk_freighter_desc", " "),
