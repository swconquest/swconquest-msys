...
["laser_bolts_blue_pistol","Plasma Gas Cartridges", [("transparent",0),("laser_bolt_blue",ixmesh_flying_ammo),("laser_bolt_blue_cartridges_pistol",ixmesh_inventory)], itp_type_bullets|itp_merchandise|itp_bonus_against_shield, 0, 100,weight(0.0)|abundance(60)|weapon_length(60)|thrust_damage(1,pierce)|max_ammo(100),imodbits_ammo],
...
["ammo_belt_pistol","Ammo Belt", [("transparent",0),("laser_bolt_yellow",ixmesh_flying_ammo),("ammo_belt",ixmesh_carry),("ammo_belt",ixmesh_inventory)], itp_type_bullets|itp_merchandise|itp_bonus_against_shield, itcf_carry_axe_back, 150,weight(0.0)|abundance(50)|weapon_length(60)|thrust_damage(1,pierce)|max_ammo(150),imodbits_none],
#@>>> Added by Swyter
...
["laser_bolts_orange_rifle","Plasma Gas Cartridges", [("transparent",0),("laser_bolt_orange",ixmesh_flying_ammo),("laser_bolt_orange_cartridges",ixmesh_inventory)], itp_type_bolts|itp_merchandise|itp_bonus_against_shield, 0, 100,weight(0.0)|abundance(80)|weapon_length(60)|thrust_damage(1,pierce)|max_ammo(125),imodbits_ammo],
["laser_bolts_yellow_rifle","Plasma Gas Cartridges", [("transparent",0),("laser_bolt_yellow",ixmesh_flying_ammo),("laser_bolt_yellow_cartridges",ixmesh_inventory)], itp_type_bolts|itp_merchandise|itp_bonus_against_shield, 0, 100,weight(0.0)|abundance(80)|weapon_length(60)|thrust_damage(1,pierce)|max_ammo(125),imodbits_ammo],
["laser_bolts_blue_rifle","Plasma Gas Cartridges", [("transparent",0),("laser_bolt_blue",ixmesh_flying_ammo),("laser_bolt_blue_cartridges",ixmesh_inventory)], itp_type_bolts|itp_merchandise|itp_bonus_against_shield, 0, 100,weight(0.0)|abundance(60)|weapon_length(60)|thrust_damage(1,pierce)|max_ammo(125),imodbits_ammo],
...
["ammo_belt_rifle","Ammo Belt", [("transparent",0),("laser_bolt_yellow",ixmesh_flying_ammo),("ammo_belt",ixmesh_carry),("ammo_belt",ixmesh_inventory)], itp_type_bolts|itp_merchandise|itp_bonus_against_shield, itcf_carry_axe_back, 150,weight(0.0)|abundance(50)|weapon_length(60)|thrust_damage(1,pierce)|max_ammo(175),imodbits_none],
#@>>> Added by Swyter
...
# practice/training
["laser_bolts_training_pistol","Laser Bolts", [("transparent",0),("laser_bolt_yellow",ixmesh_flying_ammo),("laser_bolt_yellow_cartridges",ixmesh_inventory)], itp_unique|itp_type_bullets|itp_bonus_against_shield, 0, 500,weight(0.0)|abundance(100)|weapon_length(5)|thrust_damage(1,pierce)|max_ammo(12),imodbits_none],
["laser_bolts_training_rifle","Laser Bolts", [("transparent",0),("laser_bolt_yellow",ixmesh_flying_ammo),("laser_bolt_yellow_cartridges",ixmesh_inventory)], itp_unique|itp_type_bolts|itp_bonus_against_shield, 0, 500,weight(0.0)|abundance(100)|weapon_length(5)|thrust_damage(1,pierce)|max_ammo(12),imodbits_none],
