...
#                       (this_or_next|eq, "$talk_context", tc_castle_commander),
 ...
 Ships are flown by engines, you see, and engines need men to run them or they stop. That's where I come in.", "ramun_introduce_5",[]],
...
", "lord_buy_prisoner", []],
 ...
 I'll send some men to take them to our prison with due haste.", "lord_pretalk", [
...
##       ]],
 ...
 I've to keep my mind on getting this weight off my neck.", "knight_offer_join_2",[]],
  ...
  [anyone|plyr,"knight_offer_join_accept_party", [(is_between,"$g_encountered_party",centers_begin, centers_end)], "Lead your men off the planet. I shall catch up with you in orbit.", "knight_join_party_lead_out",[]],
...
##
 ...
 Your messenger must be someone trustworthy. If you sent the datacard with a simple peasant, someone expendable,\
...
# END OF BLACKJACK MOD
  ...
  [anyone,"tavernkeeper_buy_drinks_troops_end",
   ...
   [], "Don't worry. Your men will enjoy their pints.", "tavernkeeper_pretalk",
   [
       (troop_remove_gold, "trp_player", "$temp"),
...
#Tavern Talk (with farmers)
 ...
 Our lives have become unbearable. I risked my skin and ran away to find someone who can help us.", "farmer_from_bandit_village_3", []],
  ...
  [anyone, "farmer_from_bandit_village_4", [],
   "I did, {sir/madam}, but our lord's men did not let me see him and said they were occupied with more important matters and that we should deal with our own problem ourselves.\
...
#   "Now, good {sire/lady}, is there anything I can do for you?", "village_elder_talk",[]],
 ...
 I am the planet elder and I will be honoured to serve you in any way I can.", "village_elder_talk",[]],
  ...
  [anyone ,"start", [(is_between,"$g_talk_troop",village_elders_begin,village_elders_end),
                     (party_slot_eq, "$current_town", slot_town_lord, "trp_player")],
   "{My lord/My lady}, you honour our humble planet with your presence.", "village_elder_talk",[]],
...
#SW - Bounty Hunting End  
  ...
  [anyone ,"village_elder_ask_fugitive", [],
   "Strangers come and go to our planet, {sir/madam}. If he is hiding here, you will surely find him if you look around.", "close_window",[]],
...
#  [anyone|plyr,"arena_master_talk", [], "About the arena fights...", "arena_master_melee",[]],
  ...
  [anyone|plyr,"arena_master_talk", [(party_get_num_companions,":troops","p_main_party"),(gt,":troops",1)], "I would like to spar with some of my men.", "arena_master_spar_teams",[]], # Jinnai Sparing Kit
...
# Ryan END  
  ...
  [anyone|plyr,"town_dweller_talk", [(party_slot_eq, "$current_town", slot_party_type, spt_town),
                                     (eq, "$info_inquired", 0)], "What can you tell me about this planet?", "town_dweller_ask_info",[(assign, "$info_inquired", 1)]],
