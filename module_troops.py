...
["knight_2_7","Leia Organa","knight_2_7",tf_female|tf_hero,0,reserved,fac_rebelalliance,[itm_leia_head,itm_princess_leia_blaster,itm_princess_leia_blaster,itm_princess_leia_outfit,itm_princess_leia_outfit,itm_woolen_hose,itm_laser_bolts_green_pistol,itm_hero_shield,itm_vibro_blade3],knight_attrib_5,wp(220),starwars_knight_skills_5,0x00000001bf00000836db6d86026db6db00000000001db6db0000000000000000],
...
##  ["merchant_2", "merchant_2", "merchant_2", tf_hero,               0,0, fac_rebelalliance,[itm_saddle_horse,       itm_arming_sword,       itm_light_leather,          itm_woolen_hose,                            ],              def_attrib|level(15),wp(100),knows_inventory_management_10, 0x000000000000000601db6db6db6db6db],
##  ["merchant_3", "merchant_3", "merchant_3", tf_hero,               0,0, fac_huttcartel,[itm_courser,            itm_nordic_sword,       itm_leather_jerkin,         itm_woolen_hose,                            ],              def_attrib|level(15),wp(100),knows_inventory_management_10, 0x000000000008100701db6db6db6db6db],
