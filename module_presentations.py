...
("helmet_view", prsntf_read_only, 0, [		#must use prsntf_read_only or you cannot attack
	(ti_on_presentation_load,
		...
		(else_try),
			(eq, ":item_id", "itm_shadow_stormtrooper_helmet"),
...
#SW - new create instructions
   (create_text_overlay, "$g_presentation_obj_0", "@Type your Kingdom's name:", tf_center_justify),
   (position_set_x, pos1, 500),     
...
(ti_on_presentation_event_state_change,     [
   ...
   (try_begin),
	 ...
	 #SW - added faction_set_name
	  ...
	  (display_message, "@Player Kingdom name changed."),
      (presentation_set_duration, 0),
   (try_end),   
   (try_begin),
